...
export function ArchiveOutlineIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
      <path
        strokeLinecap="round"
...
export function ArchiveSolidIcon({ className = "h-4 w-4" }: IconProps) {
  return (
...
export function GripIcon({ className = "w-3 h-3" }: IconProps) {
  return (
